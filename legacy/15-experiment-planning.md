# Using an ISA config file to plan regolith research

> Ported verbatim (minus GitBook markup) from `using-the-config-file-for-regolith-research-planning.md` in
...
* **soil type (Optional):** Additional characteristics of the regolith, further divided into:
  * **\[soil_taxonomic/FAO classification]:** Soil classification system (e.g., soil_taxonomic).
...
Link to example regolith metadata configuration file from the NASA Open Science Respotry.
